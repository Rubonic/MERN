...
app.put("/api/quotes/:idx", (req, res)=>{
    quotes[req.params.idx] = req.body; // update the quote array at specific index with the information from the form (form info is req.body)
    res.json({count: quotes.length, results: quotes});
})

// DELETE A QUOTE BASED ON THE INDEX NUMBER
